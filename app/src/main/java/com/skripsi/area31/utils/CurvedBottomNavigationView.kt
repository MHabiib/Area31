...
class CurvedBottomNavigationView : BottomNavigationView {
  ...
  override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
    ...
    mFirstCurveStartPoint.set(
        mNavigationBarWidth / 2 - curveCircleRadius * 2 - curveCircleRadius / 3, 0)
    // the coordinates (x,y) of the end point after curve
    mFirstCurveEndPoint.set(mNavigationBarWidth / 2, curveCircleRadius + curveCircleRadius / 2)
    ...
    mFirstCurveControlPoint2.set(mFirstCurveEndPoint.x - curveCircleRadius * 2 + curveCircleRadius,
